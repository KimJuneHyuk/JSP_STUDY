...
<head>
	...
	<script defer src="resources/scripts/addmember.js"></script>
...
<body>
	...
	<div class="container">
		<form name="newMember" id="newMember" class="form-horizontal"  action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			<div class="form-group  row">
				<label class="col-sm-2 ">아이디</label>
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" >
					<span class="idCheck"></span>
					<br><input type="button" name="btnIsDuplication" value="팝업 아이드 중복확인.">
