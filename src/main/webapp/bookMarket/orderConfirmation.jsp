...
<%@ page import="com.example.jsp_study.market.dtos.BookDto" %>
...
<div class="container col-8 alert alert-info">
  ...
  <div class="row justify-content-between">
    <div class="col-4" align="left">
      ...
      <p> 주 소 : <% out.println(shipping_addressName);%> (<%out.println(shipping_country);%>)</p>
    </div>
  ...
  <div>
    <table class="table table-hover">
      ...
      <%
        ...
        for (BookDto BookDto : cartList) {
          int total = BookDto.getUnitPrice() * BookDto.getQuantity();

          sum = sum + total;
      %>
      <tr>
        <td class="text-center"><em><%=BookDto.getName()%></em></td>
        <td class="text-center"><%=BookDto.getQuantity()%></td>
        <td class="text-center"><%=BookDto.getUnitPrice()%></td>
    ...
    <a href="./bookInfo.jsp?cartId=<%=shipping_cartId%>" class="btn btn-secondary" role="button">이전</a>
