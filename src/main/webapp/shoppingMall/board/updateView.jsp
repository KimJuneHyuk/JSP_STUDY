...
<div class="container">
    <form action="BoardUpdateAction.do?num=<%=notice.getNum()%>&pageNum=<%=nowPage%>" name="newUpdate"
          class="form-horizontal" method="post">

        <div class="form-group row">
            <label class="col-sm-2 control-label">성명</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" name="name" value="<%=notice.getName()%>" placeholder="name">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8" style="word-break: break-all">
                ...
                <textarea cols="50" rows="5" class="form-control" name="content"
